angular.module("me-pageloading", []).value("mePageLoadingEffects", {
    ...
    return b.prototype.getOpt = function (b) {
        ...
        var d, e = this, f = 0, g = "out" === a ? b.closingSteps : b.openingSteps, h = "out" === a ? b.closingStepsTotal : b.openingStepsTotal, i = "out" === a ? b.speedOut : b.speedIn, j = "out" === a ? b.easingOut : b.easingIn;
        j = mina[j] || mina.linear, (d = function (a) {
            return a > h - 1 ? void(c && "function" == typeof c && c()) : (e.path.animate({path: g[a]}, i, j, function () {
                d(a)
            }), void a++)
        })(f)
    }, b
    ...
    this.autoPageLoading = !0, this.effect = "random", this.$get = ["mePageLoadingTemplate", "Animater", function (a, b) {
        ...
        return e = i.autoPageLoading, f = document.createElement("div"), f = angular.element(f).html(a), g = f.children(), angular.element(document.body).append(g), h = new b({
            el: g,
            effect: i.effect
        }), {show: c, hide: d, autoPageLoading: e}
    }]
