...
angular.module('basicservice.Transfer.transferList', [ 'basicservice.Transfer.transferList.service',"basicservice.Transfer.transferList.config","basicservice.Transfer.transferList.filter"])
    ...
    [ "$scope", "$rootScope", "$stateParams", "$modal" ,"$log" ,"transfer" , "$state" , "utils"  ,"PAGINATION","$cookieStore" , "hangup", "trunk", "issync", "$sce",
        function( $scope,$rootScope, $stateParams, $modal ,$log ,transfer , $state , utils  ,PAGINATION, $cookieStore, hangup, trunk, issync, $sce ){
            $scope.searchData      = {} ;
