 ...
 *
 * */
angular.module( 'basicservice.ExtPhone.cdrList.service',[])
    .service('cdr', [ "$http", "MBS_DOMAIN" , function( $http , MBS_DOMAIN){
        this.get = function( currentPage , pageSize ,  searchData ){
            ...
            return $http.post( MBS_DOMAIN + '/Basicservice/MbsExtPhone/getCdrList/' + currentPage + '/'+ pageSize ,searchData);
        }
    }])
