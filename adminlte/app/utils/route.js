...
angular.module('app.router', ['ui.router', 'oc.lazyLoad']).provider('route', ['$stateProvider', function($stateProvider) {
    ...
    this.manager = {
        ...
        "out": {
            common: [],
            items: [{
                sref: 'out-wechat-sale-getCarList',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '微信卖车'
                ...
                sref: 'out-wechat-sale-saleDetails',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '微信卖车'
                ...
                sref: 'out-wechat-sale-buyDetails',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '微信卖车'
                ...
                sref: 'out-wechat-sale-getShareList',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '微信卖车'
                ...
                sref: 'out-wechat-sale-getStatistics',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '微信卖车'
                    },
                    query: "?&starTime&endTime"
                }
            }, {
                sref: 'out-wechat-sale-carDetails',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '微信卖车'
                ...
                sref: 'out-wechat-sale-shareDetails',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '微信卖车'
            ...
            items: [
                {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '订单管理'},
                        query: "/:currentPage?start_date&end_date&order_no&car_number&contract_no&status&province&city&dept&id&appId&type&token&payee_realname&is_jhc&contract_status"
                    }
                }, {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '支付列表'},
                        query: "/:currentPage?start_date&end_date&car_number&contract_no&order_no&status&province&city&dept&fee_type&order_type&pay_status&is_channel4"
                    }
                }, {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '收款明细'},
                        query: "/:currentPage?order_no&car_number&pay_bank&start_date&end_date&card_type&province&city&dept&order_type&pay_channel_type"
                    }
                }, {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '财务放款'},
                        query: "/:currentPage?start_date&end_date&order_no&car_number&contract_no&fee_type&pay_status&province&city&dept&pay_bank&order_type&is_voucher"
                    }
                }, {
                    ...
                    sref: 'settlement-user-userList',
                    options: {
                        files: ['service', 'index'],
                        page: {title: '用户管理'},
                        query: "/:currentPage?username&real_name&province&city&dept&status&mobile"
                    }
                }, {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '预存款复核'},
                        query: "/:currentPage?start_date1&end_date1&start_date2&end_date2&fee1&fee2&province&city&dept_id&pay_type"
                    }
                }, {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '收款到账汇总表'},
                        query: "?start_date&end_date&province&city&dept_id&bank&pay_channel&is_jhc&pay_channel_type"
                    }
                }, {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '垫款报表'},
                        query: "?province&city&dept_id&is_jhc"
                    }
                }, {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '刷卡手续费流水表'},
                        query: "/:currentPage?start_date&end_date&source_type&province&city&dept_id&is_jhc"
                    }
                }, {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '合同'},
                        query: "/:currentPage?start_date&end_date&order_no&car_number&contract_no&status&province&city&dept&id&order_type"
                    }
                }, {
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '资金对账'},
                        query: "/:currentPage?start_date&end_date&start_confirm_date&end_confirm_date&receiving_bak&pay_channel_type"
                    }
                }, {
                    ...
                    sref: 'settlement-statement-detail6',
                    options: {
                        files: ['service', 'index'],
                        page: {
                            title: 'T1对账明细'
                    ...
                    sref: 'settlement-statement-transDetail',
                    options: {
                        files: ['service', 'index'],
                        page: {
                            title: '刷卡对账明细'
                        },
                        query: "/:currentPage??pay_channel&entry_time&merchant_id&terminal_id"
                    }
                },{
                    ...
                    options: {
                        files: ['service', 'index'],
                        page: {title: '各款项收支流水表'},
                        query: "/:currentPage?start_date&end_date&province&city&dept_id&pay_bank&pay_channel&order_no&is_jhc&pay_channel_type"
                    }
                }, {
        ...
        "joining": {
            common: ["service", "directive", "filter"],
            items: [{
                sref: 'joining-order-orderList',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '订单管理'
                    },
                    query: "/:currentPage?start_date&end_date&order_no&contract_no&status&province&city&dept&id&appId&type&token&name"
                }
            }, {
                sref: 'joining-deptAccountTransferDetail-index',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '刷卡明细'
                    },
                    query: "/:currentPage?order_no&car_number&pay_bank&start_date&end_date&card_type&province&city&dept&order_type"
                }
            }, {
                sref: 'joining-order-addOrder',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '订单添加'
                ...
                sref: 'joining-finance-index',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '财务付款'
                    },
                    query: "/:currentPage?order_no&type&start_date&end_date&pay_bank&pay_status"
                }
            }, {
                sref: 'joining-finance-pay',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '财务支付'
        ...
        "basicservice": {
            items: [{
                ...
                sref: 'basicservice-Msg-sendTest',
                options: {
                    files: ['service', 'index', 'filter', 'directive'],
                    page: {
                        title: '短信测试'
                    },
                    query: "/:currentPage?app&channel&caller&called"
                }
            }, {
                sref: 'basicservice-App-channelDosage',
                options: {
                    files: ['service', 'index', 'filter'],
                    page: {
                        title: '通道用量'
                ...
                sref: 'basicservice-App-callTest',
                options: {
                    files: ['service', 'index', 'filter'],
                    page: {
                        title: '回拨测试'
                ...
                sref: 'basicservice-App-bindList',
                options: {
                    files: ['service', 'index', 'filter', 'directive'],
                    page: {
                        title: '绑定查询'
                    },
                    query: "/:currentPage?caller&province&city&dept_id&user_id&hangup_cause&source&start_date&end_date&follow_user_id&user&is_sync"
                }
            }, {
                sref: 'basicservice-App-callBack',
                options: {
                    files: ['service', 'index', 'filter', 'directive'],
                    page: {
                        title: '回拨查询'
                    },
                    query: "/:currentPage?caller&called&province&city&dept_id&user_id&hangup_cause&source&start_date&end_date&follow_user_id&user&is_sync"
                }
            }, {
                sref: 'basicservice-App-dosageRemain',
                options: {
                    files: ['service', 'index', 'filter'],
                    page: {
                        title: '第三方接口余量'
        ...
        "chefubao": {
            ...
            items: [{
                ...
                sref: 'chefubao-DeptIncomeExpense-deptList',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '门店收入、支出、余额'
                ...
                sref: 'chefubao-statement-detail',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '对账明细'
                    },
                    query: "/:currentPage??channel&settlement_date&merchant_id&terminal_id"
                }
            }, {
                sref: 'chefubao-statement-detail6',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: 'T1对账明细'
                ...
                sref: 'chefubao-statement-getStatementList',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '资金对账'
                    },
                    query: "/:currentPage?start_date&end_date&start_confirm_date&end_confirm_date&receiving_bak&pay_channel&pay_channel_type"
                }
            }, {
                sref: 'chefubao-incomeExpenses-detail',
                options: {
                    files: ['service', 'index'],
                    page: {
                        title: '各款项收支流水表'
        ...
        "chekuangbao": {
            common: ["directive"],
            items: [{
                sref: "chekuangbao-assign-getOrderList-map",
                options: {
                    files: ["service", "index"],
                    page: {
                        title: "订单管理系统"
                ...
                sref: "chekuangbao-assign-getOrderList",
                options: {
                    files: ["service", "index"],
                    page: {
                        title: "订单管理系统"
                    },
                    query: "/:currentPage?pageSize&listType&searchType&searchText"
                }
            }, {
                sref: "chekuangbao-order-createcheckorder",
                options: {
                    files: ["service", "index"],
                    page: {
                        title: "模拟创建订单"
        ...
        "contract": {
            ...
            items: [{
                    ...
                    options: {
                        ...
                        query: "/:currentPage?sale_price_1&sale_price_2&brokerage_1&brokerage_2&start_date&end_date&is_juhaoche&contract_no&car_number&status&dept_id&buyer_tracer_province&buyer_tracer_city&buyer_tracer_shop&buyer_tracer"
                    }
                }, {
