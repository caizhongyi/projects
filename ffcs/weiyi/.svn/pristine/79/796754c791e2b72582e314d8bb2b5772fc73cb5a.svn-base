...
(function (z, m) {
    ...
    function Yb(a, b, c, d) {
        var e = [Wa === "" ? "<html>" : '<html dir="' + Wa + '">', '<head><meta charset="utf-8" /><title></title>', "<style>", "html {margin:0;padding:0;}", "body {margin:0;padding:5px;}", 'body, td {font:12px/1.5 "sans serif",tahoma,verdana,helvetica;}', "body, p, div {word-wrap: break-word;}", "p {margin:5px 0;}", "table {border-collapse:collapse;}", "img {border:0;max-width:100%;}", "noscript {display:none;}", "table.ke-zeroborder td {border:1px dotted #AAA;}",
    ...
    function $a(a) {
        for (var b =
            document.getElementsByTagName("head")[0] || (N ? document.body : document.documentElement), c = document.createElement("link"), d = Eb(ga(a, "absolute")), e = f('link[rel="stylesheet"]', b), g = 0, h = e.length; g < h; g++)if (Eb(ga(e[g].href, "absolute")) === d)return;
        b.appendChild(c);
        c.href = a;
        c.rel = "stylesheet"
    }
    ...
    if (!z.KindEditor) {
        ...
        var Ea = "4.1.4 (2012-11-11)", q = navigator.userAgent.toLowerCase(),
        ...
        f.options = {designMode: !0, fullscreenMode: !1, filterMode: !0, wellFormatMode: !0, shadowMode: !0, loadStyleMode: !0, basePath: f.basePath, themesPath: f.basePath + "themes/", langPath: f.basePath + "lang/", pluginsPath: f.basePath + "plugins/", themeType: "default", langType: "zh_CN", urlType: "", newlineTag: "p", resizeType: 2, syncType: "form", pasteType: 2, dialogAlignType: "page",
            useContextmenu: !0, fullscreenShortcut: !1, bodyClass: "ke-content", indentChar: "\t", cssPath: "", cssData: "", minWidth: 650, minHeight: 100, minChangeSize: 50, items: ["source", "|", "undo", "redo", "|", "preview", "print", "template", "code", "cut", "copy", "paste", "plainpaste", "wordpaste", "|", "justifyleft", "justifycenter", "justifyright", "justifyfull", "insertorderedlist", "insertunorderedlist", "indent", "outdent", "subscript", "superscript", "clearhtml", "quickformat", "selectall", "|", "fullscreen", "/", "formatblock", "fontname", "fontsize",
                "|", "forecolor", "hilitecolor", "bold", "italic", "underline", "strikethrough", "lineheight", "removeformat", "|", "image", "multiimage", "flash", "media", "insertfile", "table", "hr", "emoticons", "baidumap", "pagebreak", "anchor", "link", "unlink", "|", "about"], noDisableItems: ["source", "fullscreen"], colorTable: [
        ...
        f.queryAll = Aa;
        F(D, {init: function (a) {
            for (var a = W(a) ? a : [a], b = 0, c = 0, d = a.length; c < d; c++)a[c] && (this[c] = a[c].constructor === D ? a[c][0] : a[c],
                b++);
            this.length = b;
            this.doc = S(this[0]);
            this.name = La(this[0]);
        ...
        F(K, {init: function (a) {
            ...
            if (o) {
                ...
                if (a === ha || a === $)g = this.endContainer, i = this.endOffset;
                if (a === ia || a === ha)h = b.startContainer, j = b.startOffset;
                if (a === $ || a === ja)h = b.endContainer, j = b.endOffset;
        ...
        F(la, {init: function (a) {
            ...
            commonAncestor: function (a) {
                ...
                if (a === "forecolor")return(a = this.commonNode({"*": ".color"})) && (c = a.css("color")), c = ua(c), c === "" && (c = "default"), c.toLowerCase();
                if (a === "hilitecolor")return(a =
                    this.commonNode({"*": ".background-color"})) && (c = a.css("background-color")), c = ua(c), c === "" && (c = "default"), c.toLowerCase();
                return c
            }, toggle: function (a, b) {
            ...
            fontfamily: function (a) {
                ...
                b && (e += ' target="' +
                    B(b) + '"');
                if (d.collapsed)return e += ">" + B(a) + "</a>", this.inserthtml(e);
                if (d.isControl()) {
        ...
        F(na, Q, {init: function (a) {
            ...
            var d = n(a.themesPath, ""), e = a.bodyClass, g = a.cssPath, h = a.cssData, i = location.host.replace(/:\d+/, "") !== document.domain, j = "document.open();" + (i ? 'document.domain="' + document.domain + '";' : "") + "document.close();",
        ...
        F(oa, Q, {init: function (a) {
            ...
            if (a.title === "-")this.div.append(f('<div class="ke-menu-separator"></div>')); else {
                var b = f('<div class="ke-menu-item" unselectable="on"></div>'), c = f('<div class="ke-inline-block ke-menu-item-left"></div>'), d = f('<div class="ke-inline-block ke-menu-item-right"></div>'), e = r(a.height), g = n(a.iconClass, "");
                this.div.append(b);
        ...
        F(Ya, {init: function (a) {
            var b = f(a.button), c = a.fieldName || "file", d = a.url || "", e = b.val(), es = b.attr("style"), g = a.extraParams || {}, h = b[0].className || "", i = a.target || "kindeditor_upload_iframe_" + (new Date).getTime();
            ...
            for (l in g)j.push('<input type="hidden" name="' +
                l + '" value="' + g[l] + '" />');
            c = ['<div class="ke-inline-block">', a.target ? "" : '<iframe name="' + i + '" style="display:none;"></iframe>', a.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + i + '" action="' + d + '">', '<span style="cursor:pointer;">', j.join(""), '<button class="' + h + '" style="' + es + '">' + e + '</button>', "</span>", '<input type="file" onchange="aceUploadFileAnsy(this)" class="ke-upload-file" name="' + c + '" tabindex="-1" />', a.form ? "</div>" :
                "</form>", "</div>"].join("");
            c = f(c, b.doc);
            b.hide();
            b.before(c);
        ...
        F(qa, Q, {init: function (a) {
            ...
            k([
                ...
                if (this.btn) {
                    var a = this.btn, a = a || {}, b = a.name || "",
                        c = f('<span class="ke-button-common ke-button-outer" title="' + b + '"></span>'), b = f('<input class="ke-button-common ke-button" type="button" value="' + b + '" />');
            ...
            this.mask = null;
            if (j)d = I(this.doc), this.mask = Va({x: 0, y: 0, z: this.z - 1, cls: "ke-dialog-mask", width: Math.max(d.scrollWidth, d.clientWidth),
            ...
            this.loading = f('<div class="ke-dialog-loading"><div class="ke-inline-block ke-dialog-loading-content" style="margin-top:' + Math.round(b.height() / 3) + 'px;">' + a + "</div></div>").width(b.width()).height(b.height()).css("top", this.headerDiv.height() +
                "px");
        ...
        f.ajax = function (a, b, c, d, e) {
            var c = c || "GET", e = e || "json", f = z.XMLHttpRequest ? new z.XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
            f.open(c, a, !0);
        ...
        ra.prototype = {lang: function (a) {
            ...
            function b(a, b, d) {
                ...
                if (b &&
                    b >= c.minHeight && (c.resize(null, b), d))c.height = r(b)
            }
            ...
            var i = c.toolbar = Bb({src: i, html: k.join(""), noDisableItems: c.noDisableItems, click: function (a, b) {
                ...
                c.clickToolbar(b)
            }}), m = s(g) - i.div.height(), q = c.edit = zb({height: m > 0 && s(g) > c.minHeight ? m : c.minHeight,
            ...
            d ? (f(z).bind("resize", function () {
                ...
                c._scrollPos = Z()
            }), c.resizeType > 0 ? Ta({moveEl: h, clickEl: l, moveFn: function (a, c, d, e, f, g) {
                e += g;
                b(null, e)
            }}) : l.first().css("visibility", "hidden"), c.resizeType === 2 ? Ta({moveEl: h, clickEl: l.last(), moveFn: function (a, c, d, e, f, g) {
                d += f;
                e += g;
                b(d, e)
            ...
            this.isCreated ?
                this.edit.html(a) : ma(this.srcElement, a);
            return this
        }, fullHtml: function () {
            ...
            var a =
                n(a, !0), b = this.edit, c = b.doc.body, d = ab(c.innerHTML);
            ...
            b.designMode && !this._firstAddBookmark ? (b = this.cmd.range, a = b.createBookmark(!0), a.html = ab(c.innerHTML), b.moveToBookmark(a)) : a = {html: d};
            ...
            a.closeBtn = n(a.closeBtn, {name: b.lang("close"), click: function () {
                b.hideDialog();
                o && b.cmd && b.cmd.select()
            }});
            a.noBtn = n(a.noBtn, {name: b.lang(a.yesBtn ? "no" : "close"), click: function () {
                b.hideDialog();
                o && b.cmd && b.cmd.select()
            }});
        ...
        Fb("core", function (a) {
            ...
            b.clickToolbar("formatblock", function () {
                var a = b.lang("formatblock.formatBlock"),
                    c = {h1: 28, h2: 24, h3: 18, H4: 14, p: 12}, d = b.cmd.val("formatblock"), f = b.createMenu({name: "formatblock", width: b.langType == "en" ? 200 : 150});
                k(a, function (a, e) {
            ...
            b.clickToolbar("fontsize", function () {
                ...
                k(b.fontSizeTable, function (d, f) {
                    c.addItem({title: '<span style="font-size:' + f + ';" unselectable="on">' + f + "</span>", height: s(f) + 12, checked: a === f, click: function () {
                        b.exec("fontsize",
                            f).hideMenu()
                    }})
                })
            ...
            b.addContextmenu({title: "-"});
            k("selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript,hr,print,bold,italic,underline,strikethrough,removeformat,unlink".split(","), function (a, d) {
                c[d] && b.afterCreate(function () {
                    Ha(this.edit.doc, c[d], function () {
                        b.cmd.selection();
                        b.clickToolbar(d)
            ...
            b.afterCreate(function () {
                function c() {
                    ...
                    var d = j[0].innerHTML;
                    j.remove();
                    d !== "" && (b.pasteType === 2 && (/schemas-microsoft-com|worddocument|mso-\w+/i.test(d) ? d = mb(d, b.filterMode ? b.htmlTags : a.options.htmlTags) :
