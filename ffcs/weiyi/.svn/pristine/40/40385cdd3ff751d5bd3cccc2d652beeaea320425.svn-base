...
class Weixin {
    ...
    public function send_all($content){
        ...
        $this->referer = 'https://mp.weixin.qq.com/cgi-bin/masssendpage?token='.$this->token.'&t=mass/send&lang=zh_CN';
    ...
    public function get_groups(){
        $url="https://".$this->host."cgi-bin/groups/get?access_token=".$this->token;
    ...
    public function create_groups(){
        $url="https://".$this->host."/cgi-bin/groups/create?access_token=".$this->token;
        $json=file_get_contents($url);
        $result=json_decode($json,true);
        return $result;
    }
