    ...
    $.formValidator = {
        ...
        setTipState : function(elem, showclass, showmsg) {
            ...
            if (showmsg == "=HIDE=") {
                ...
                //roy修改，如果是onError则输入框会变红
                if(showclass == "onError"){
                    tip.prev('input').addClass('formError');
                    tip.prev('textarea').addClass('formError');
                    tip.prev('select').addClass('formError');
                }else{
                    tip.prev('input').removeClass('formError');
                    tip.prev('textarea').removeClass('formError');
                    tip.prev('select').removeClass('formError');
                }
                tip.removeClass();
