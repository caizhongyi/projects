...
<div class="page-header">
	...
	<div class="main">
					...
					<div class="sub-content">
						<table class="tb">
							...
							<tr>
								...
								<td>
									<input type="text" class="span6" value="<?php  echo $_W['siteroot'];?>api.php?hash=<?php  echo $wechat['hash'];?>" readonly="readonly" autocomplete="off"/>&nbsp;<a href="http://www.vieasy.cn/setting.php?act=help&foo=displayone&id=70"  target="_blank">配置图例</a>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="alert alert-info">
                                        配置自定义菜单：支持自定义菜单的有微信的认证订阅号和服务号，对于易信的公众账号都支持
                                    </div>
                                </td>
                            </tr>
                            <tr class="adv-setting">
                                <th>公众号AppId</th>
                                <td>
                                    <input type="text" name="key" class="span6" value="<?php  echo $wechat['key'];?>" autocomplete="off"/>&nbsp;<a href="http://www.vieasy.cn/setting.php?act=help&foo=displayone&id=70"  target="_blank">配置图例</a>
							...
							<tr class="hide">
								...
								<td>
									<div class="fileupload fileupload-new" data-provides="fileupload">
										<div class="fileupload-preview thumbnail" ><?php  if(file_exists(IA_ROOT . '/resource/attachment/headimg_'.$wechat['weid'].'.jpg')) { ?><img class="img-polaroid" src="<?php  echo $_W['attachurl'];?>/headimg_<?php  echo $wechat['weid'];?>.jpg?time=<?php  echo time()?>" width="85" /><?php  } ?></div>
										<div>
			...
			<div id="accont-press" class="tab-pane fade">
				<div class="sub-item">
					<h4 class="sub-title"> <small>在一键获取模式下设置用户名密码后，程序会自动采集您的公众号相关信息。我们不会保存您的公众号的用户名密码。</small></h4>
				</div>
				<div class="sub-item" id="table-list">
					<div class="sub-content">
						<table class="tb">
