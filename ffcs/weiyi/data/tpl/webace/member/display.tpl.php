<?php defined('IN_IA') or exit('Access Denied');?><?php if(empty($_GPC['status'])) { ?><?php $_W['breadcrumb'] = array(array('title'=>'系统管理'),array('title'=>'用户管理 '),array('title'=>'用户列表 '))?><?php } ?>
<?php if($_GPC['status'] == -1) { ?><?php $_W['breadcrumb'] = array(array('title'=>'系统管理'),array('title'=>'用户管理 '),array('title'=>'审核用户 '))?><?php } ?>
	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php if(!$m['founder']) { ?>
					<div><a href="./member.php?act=edit&uid=<?php echo $m['uid'];?>">设置操作权限</a>&nbsp;&nbsp;<a href="javascript:;" onclick="u.deny('<?php echo $m['uid'];?>', '<?php echo $m['status'] == '-1' ? '0' : '-1';?>');"><?php echo $m['status'] == '-1' ? '启用' : '禁止';?>用户</a>&nbsp;&nbsp;<a href="javascript:;" onclick="u.del('<?php echo $m['uid'];?>');">删除用户</a></div>
					<?php } ?>
				</td>
			</tr>
			<?php } } ?>
