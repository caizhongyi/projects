                        ...
                        <div class="infobox-container">
                            <div class="infobox infobox-master infobox-dark">
                                ...
                                <div class="infobox-data">
                                    ...
                                    <div class="infobox-content"><?php echo $current_wechats['response']['today'];?></div>
                                </div>
                            </div>
                            ...
                            <div class="infobox infobox-master infobox-dark">
                                ...
                                <div class="infobox-data">
                                    <div class="infobox-content">新增人数</div>
                                    <div class="infobox-content"><?php echo $current_wechats['fans']['todayjoin'];?></div>
                                </div>
                            </div>
                            ...
                            <div class="infobox infobox-master infobox-dark">
                                ...
                                <div class="infobox-data">
                                    ...
                                    <div class="infobox-content"><?php echo $current_wechats['fans']['total'];?></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-header">
                                <div class="widget-toolbar no-border">
                                    <ul id="recent-tab" class="nav nav-tabs">
                                        ...
                                        <li>
                                            <a href="#newfans-tab" data-toggle="tab">新增人数</a>
                                        </li>

                                          <li>
                                                <a href="#member-tab" data-toggle="tab">总用户数</a>
                                           </li>
                                    </ul>
                                </div>
                            </div>
...
<div class="main">
    <div class="section">
        <div class="account">
            <div class="account-item">公共账号名称：我们的小伙伴（易信公共号）</div>
            <div class="account-item">测验绑定状态： <a href="" class="unbind">未绑定</a> (未验证，说明您的公共账号可能存在未绑定成功的情况。)</div>
        </div>
        <div class="infobox-container">
        ...
        <div class="alert alert-mini alert-warning">
            <h4>系统公告</h4>
            <a href="" class="alert-enter">更多 ＞</a>
        </div>

        <ol class="list">
            <li>内容内容内容内容内容内容内容内容内容内容……</li>
            <li>内容内容内容内容内容内容内容内容内容内容……</li>
            <li>内容内容内容内容内容内容内容内容内容内容……</li>
            <li>内容内容内容内容内容内容内容内容内容内容……</li>
            <li>内容内容内容内容内容内容内容内容内容内容……</li>
