<?php defined('IN_IA') or exit('Access Denied');?><?php $_W['breadcrumb'] = array(array('title'=>'微会员'),array('title'=>'商家设置'))?>
<?php $load_js=array('map');?>
<?php $load_css=array('resource');?>
<?php include template('common/header', TEMPLATE_INCLUDEPATH);?>
<div class="page-header">
    <h1>
        <i class="icon-cog"></i> 商家设置
    </h1>
</div>
<div class="main">
        ...
        <table id="form"
            ...
            <tr>
                ...
                <td><input type="text" id="" class="span7" placeholder=""
                           name="name" value="<?php echo $business_setting['name'];?>"></td>
            </tr>
            <tr>
                <th>图文消息封面</th>
                <td>
                    <div id="" class="uneditable-input reply-edit-cover">
                        ...
                        <?php if(!empty($business_setting)) { ?> <input type="hidden"
                                                            name="frontcover" value="<?php echo $business_setting['frontcover'];?>">
                        <div id="upload-file-view" class="upload-view">
                            <img width="100" src="<?php echo $_W['attachurl'];?><?php echo $business_setting['frontcover'];?>">&nbsp;&nbsp;
                        </div>
                        <?php } else { ?>
            ...
            <tr>
                ...
                <td><textarea style="height: 80px;" class="span7" cols="70" id="description"
                              name="description"><?php echo $business_setting['description'];?></textarea>
                </td>
            </tr>
            <script type="text/javascript">
            ...
            <tr>
                ...
                <td><select name="area_p" id="area_p">
                    ...
                    <script type="text/javascript">
                        new PCAS("area_p", "area_c", "area_a", '<?php echo $business_setting['area_p'];?>', '<?php echo $business_setting['area_c'];?>', '<?php echo $business_setting['area_a'];?>');
                    </script>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th>商家详细地址</th>
                <td><input type="text" id="" class="span7" placeholder=""
                           name="address" value="<?php echo $business_setting['address'];?>"></td>
            </tr>
            <tr>
                <th>商家联系方式</th>
                <td><input type="text" id="" class="span7" placeholder=""
                           name="phonenum" value="<?php echo $business_setting['phonenum'];?>"></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" id="suggestId" class="input-xlarge" name="place" value="<?php echo $business_setting['place'];?>" data-rule-required="true" />
                    ...
                    <div id="r-result">
                        <input type="text" id="lng" name="lng" value="<?php echo $business_setting['lng'];?>" /><input type="text" id="lat" name="lat" value="<?php echo $business_setting['place'];?>" />
                    </div>
                </td>
            </tr>
            <script type="text/javascript">
                $(function () {
                    var lat = "<?php echo $business_setting['lat'];?>";
                    var lng = "<?php echo $business_setting['lng'];?>";
                    var place = "<?php echo $business_setting['place'];?>";
