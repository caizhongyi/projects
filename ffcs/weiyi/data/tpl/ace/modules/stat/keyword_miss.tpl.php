<?php defined('IN_IA') or exit('Access Denied');?><?php $_W['breadcrumb'] = array(array('title'=>'统计分析 '),array('title'=>'规则使用率'),array('title'=>'未触发关键字'))?>
<?php include $this->template('common/header', TEMPLATE_INCLUDEPATH);?>
<div class="page-header">
    <h1>
        <i class="icon-book"></i> 未触发关键字
    </h1>
</div>
	<div class="main">
		<div class="stat">
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="row-hover"><?php echo $row['content'];?></td>
