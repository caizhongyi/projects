...
<ul class="nav nav-tabs padding-24 tab-color-blue background-blue ">
    <li <?php if($_GPC['foo'] == 'hit' || empty($_GPC['foo'])) { ?>class="active"<?php } ?>><a href="<?php echo create_url('index/module/keyword', array('name' => 'stat', 'foo' => 'hit'))?>">已触发关键字</a></li>
    <li <?php if($_GPC['foo'] == 'miss') { ?>class="active"<?php } ?>><a href="<?php echo create_url('index/module/keyword', array('name' => 'stat', 'foo' => 'miss'))?>">未触发关键字</a></li>
</ul>
<div class="sub-item">
