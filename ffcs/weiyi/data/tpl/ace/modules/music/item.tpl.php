		...
		<tr>
			...
			<td>
				...
				<div class="input-append">
					...
					<input type="button" id="music-attach-btn" fieldname="music-attach<?php echo $namesuffix;?>" class="btn" value="<i class='icon-upload-alt'></i>" style="font-size:14px;width:80px;margin-left:-1px;">
				</div>
