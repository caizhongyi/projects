<?php defined('IN_IA') or exit('Access Denied');?><?php $_W['breadcrumb'] = array(array('title'=>'系统管理 '),array('title'=>'模块管理'),array('title'=>'模块列表'))?>
...
<div class="main">
	<div class="tab-content no-border padding-24 no-padding-left no-padding-right form-horizontal">
