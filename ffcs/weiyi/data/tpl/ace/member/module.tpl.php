...
<style type="text/css">
    .thumbnail{ height:250px; margin-bottom: 20px;}
                ...
                <div class="col-xs-4" style="height:auto;">
                    <div class="thumbnail">
                        ...
                        <div class="module-button">
                            ...
                            <?php } ?>
                            <?php if($row['settings'] && $row['enabled']) { ?><a href="<?php echo create_url('member/module/setting', array('mid' => $row['mid']))?>" class="btn module-button-switch">设置</a><?php } ?>
