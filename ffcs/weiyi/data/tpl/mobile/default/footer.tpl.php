<?php defined('IN_IA') or exit('Access Denied');?>	<?php  if(empty($footer_off)) { ?><div id="footer">&copy;<?php  if(empty($_W['account']['name'])) { ?>微擎团队<?php  } else { ?><?php  echo $_W['account']['name'];?><?php  } ?></div><?php  } ?>
</div>
<?php  if($_W['quickmenu']['menus']) { ?>
	<?php  include $this->template($_W['quickmenu']['template'], TEMPLATE_INCLUDEPATH);?>
<?php  } ?>
