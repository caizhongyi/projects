...
?>
    ...
    <div id="demoSendBox" style="position:absolute;right:12px; top:20px;">
        <div class="chatPanel" style="width:300px;">
            <h5 style="margin-bottom:10px;">预览效果</h5>
            ...
            <div class="chatItem you">
                <div id="svtext" style="text-align:left; padding-bottom:10px;display:none;">
                  <img src="./resource/image/noavatar_middle.gif" style="width:34px;height:34px;margin-left:6px; float:left;" class="img-rounded">
                    <div class="btn btn-success" style="margin-left: 4px;float: left;max-width: 184px;text-align:left;white-space:normal;">回复内容</div>
                    <div style="clear:both;"></div>
                </div>
