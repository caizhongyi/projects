...
print('<div class="we7_tips_header" style="padding-left:5px;"><a title="关闭" href="javascript:;" onclick="closetips()" class="we7_tips_close"></a><div class="we7_tips_title">微翼提醒您</div></div>');
