...
function file_upload($file, $type = 'image', $sname = 'auto') {
	...
	if (empty($_W['uploadsetting'])) {
        ...
        $_W['uploadsetting']['file']['folder'] = 'file';
        $_W['uploadsetting']['file']['extentions'] = $_W['config']['upload']['file']['extentions'];
        $_W['uploadsetting']['file']['limit'] = $_W['config']['upload']['file']['limit'];
	}
