		...
		tag: function(options) {
			...
			return this.each(function() {
				...
				$(window).load(function(){
					...
					$(".jTagTag").on('mouseenter',function(){
					...
					$(".jTagTag").on('mouseleave',function(){
						if($(".jTagDrag").length==0){
					...
					if(options.showLabels && options.showTag != 'always'){
						...
						$(".jTagLabels label").on('mouseenter',function(){
							$("#"+$(this).attr('rel')).css('opacity',1).find("span").show();
							$(".jTagDeleteTag").show();
						});
						
						$(".jTagLabels label").on('mouseleave',function(){
					...
					if(options.canDelete){
						...
						$('.jTagDeleteTag').on('click',function(){
