var _lang = {
    zh: {
        ...
        btn_resume: "继续找",
        loading: "加载中...",
        lv_txt: ["才找到这么点妹子，哈哈哈哈哈哈，你怎么过好这一生呢！", "你这么花心，你女人知道吗？", "你也是蛮拼的，这么多妹子你是怎么找的，留个微信交流下呗", "哼，命硬不敢说喔，你命根子肯定硬啦", "你终于明白了袜子和妹子的区别...", "我竟无言以对，你走吧，这个游戏不适合你", "应该没有人能玩到这个级别，如果有的话，我就吞粪自尽！",],
        share_txt1: "【找妹子】我在",
        share_txt2: "只袜子中找到",
        share_txt3: "个妹子，他们说【",
        share_txt4: "】，不服来打我啊！",
        desc: "找出所有'袜'字中的'妹'字。分享朋友圈，告诉所有人，你是人生赢家！"
    },
    en: {
...
shareData = {
    imgUrl: "http://www.nanrenwa.com/game/3/icon.jpg",
    timeLineLink: "http://www.nanrenwa.com/game/3/3.php?u=" + Math.floor(Math.random()*10000000),
...
function(a) {
    ...
    f = {
        init: function() {
            this.initEvent(),
            this.loading(),
            /android/i.test(c) ? (b.banner.attr("href", "http://www.nanrenwa.com/").data("type", "android").find("img").attr("src", "assets/img/banner.android.jpg"), b.banner.show()) : /iphone|ipad|ipod/i.test(c) && (b.banner.attr("href", "http://www.nanrenwa.com/").data("type", "ios").find("img").attr("src", "assets/img/banner.ios.jpg"), b.banner.show())
        },
        loading: function() {
            function a() {
                d++,
