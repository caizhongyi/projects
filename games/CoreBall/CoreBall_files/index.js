...
gameurlTimeline = 'http://mp.weixin.qq.com/s?__biz=MzA5MTI2MjQyOA==&mid=204566582&idx=1&sn=50e1040e07521ccd20f1c625ce2e49bc#rd';
...
if (match) {
    ...
    $AJB.general.BeginStage = function() {
        "use strict";
        function a(a) {    // 1.开始结束按钮的显示隐藏 2.
            function c() {
               b(h, "click", function() { // b = $AJB.lib.addEvent();  h = a.getElementsByClassName("button")[0]
                  e.fire(g, f);   //e = c(), f = 0, g = "start";
               }),
               j.innerHTML = d.isAndroid ? "GO" : "▶";   //d = $AJB.lib.util(), j= document.getElementById("txtAr")
            }
    ...
    $AJB.general.Switcher = function() {
        "use strict";
        function a(a, b, c) { //a getContext("2d")  b widht  c height
            var d, e, f = null,
                g = !1,
                h = {
                    point: [0, 0],
                    ...
                    update: function() {
                        ...
                        h.enabled && (
                           0 === e ? (
                              ...
                              d = "#000", a[0] > b / 2 ? (a[0] = Math.max(a[0] - c, b / 2), h.point = a) : (h.point = a, g = !0)
                           )
                        )
                    },
                    render: function() {
    ...
    $AJB.general.Levels = function() {
        ...
        function c(a, b, c, d) {    //2, 2.3, 1200, 1
            return function() {
                var e = 0, f = +new Date;
                return function() {
                    var g = +new Date;
                ...
                j = {
                    ...
                    render: function() {
                        var c, e = l.length,
                            f = a.width,
                            h = a.height;
                        for (d.clearRect(0, 0, f, h), c = 0; e > c; c++) b.drawLine(d, n, o, l[c].ball.pos().x,
                            l[c].ball.pos().y, "#ffffff", 1.5 * g),
                            l[c].ball.render();
                        i.render()
                    },
                    destroy: function() {
        ...
        function a(a, b, l, m) {
            ...
            return u = {
                ...
                update: function() {
                    var a;
                    u.enabled && ("run" === A ? o() : 
                        "pass" === A ? (p(), +new Date - v > 1e3 && (A = "", k.fire(i))) : 
                            "fail" === A && (a = +new Date - v, q(a), a > 1e3 && (A = "", k.fire(j))))
                },
                render: function() {
    ...
    $AJB.general.Game = function() {
        ...
        function a() {
            ...
            r.width = a,
            r.height = b,
            i = l(x, a, b),   //l = $AJB.general.Switcher(), x = r.getContext("2d"), r = document.getElementById("stage")
                ...
                i.switchStage(0, function() {
                    h.enabled = !1,
                       ...
                       testGlobalFailNum(),
                        ga('send', {
                            'hitType': 'event', // Required.
                            'eventCategory': 'failed', // Required.
                            'eventAction': "level_" + D, // Required.
                            'eventLabel': "",
                            'eventValue': 1
                        })
                })
        ...
        function g() {
            ...
            e(),
            c(),
            C.level(D), //C = m(s), s = document.getElementById("begin"), D = +o.getValue(z) || 1, o = $AJB.lib.Storage(), 
            C.show(),
            f()
        }
...
ajax.post('http://timelineapp.pointstone.org/ci/authorize/get_jssdk_info', {
    ...
    if (jssdk_info_obj.sess_openid != openid){
    ...
    wx.ready(function() {
        btnJump.addEventListener('touchstart' ,function(){
            tipJump = document.getElementById("tipJump");
            payBtn = document.getElementById("payBtn");

            tipJump.style.display = "";

            setTimeout(function() {
                // tipJump.style.display = "none";
                ajax.post('http://timelineapp.pointstone.org/wxpay-php/wxpayapi.php',
                    {
                        openid: openid,
                        level: GlobalLevel
                    },
                    function(data) {
                        var payPackage = JSON.parse(data);
                        // if (payPackage)
                        // alert(payPackage);
                        total_fee = payPackage.total_fee / 100.0;
                        tipJump.style.display = "none";
                        payBtn.style.display = "";
                        payBtn.innerHTML = "支付" + total_fee + "元，跳过本关";
                        ...
                        payBtn.addEventListener('touchstart' ,function(){
                          wx.chooseWXPay({
                              ...
                              signType: payPackage.signType, // 注意：新版支付接口使用 MD5 加密
                              ...
                              success: function () {
                               ...
                               ga('send', {
                                    'hitType': 'event', // Required.
                                    'eventCategory': 'payed', // Required.
                                    'eventAction': "level_" + GlobalLevel, // Required.
                                    'eventLabel': "",
                                    'eventValue': 1
                                });
                                ...
                                if (window.localStorage) {
                                    ...
                                    st.setItem('core-ball-level', GlobalLevel);
