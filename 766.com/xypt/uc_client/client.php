...
//define('UC_DBHOST', '220.162.238.138');
//define('UC_DBUSER', 'usertest766');
//define('UC_DBPW', 'By6SGqLatQAyDDXh');
//define('UC_DBNAME', 'u_766_com');
//define('UC_DBCHARSET', 'utf8');
//define('UC_DBTABLEPRE', '`u_766_com`.uc_');
...
function uc_avatar($uid, $type = 'virtual', $returnhtml = 1) {
	...
	$uc_avatarflash = UC_API.'/flash/camera.swf?inajax=1&appid='.UC_APPID.'&input='.$uc_input.'&agent='.md5($_SERVER['HTTP_USER_AGENT']).'&ucapi='.urlencode(str_replace('http://', '', UC_API)).'&avatartype='.$type;
	if($returnhtml) {
