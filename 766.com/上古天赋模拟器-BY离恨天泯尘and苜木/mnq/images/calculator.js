...
ArcheAge.Web.AbilityCalculator.prototype.setData = function(a) {
	var b = this;
	null == a || void 0 == a || (b.reset(), b.data_ = JSON.parse(JSON.stringify(a)), void 0 == b.data_.abilities && (b.data_.abilities = []), void 0 != b.data_.points && (b.points_ = b.data_.points), void 0 != b.data_.levelMax && (b.levelMax_ = b.data_.levelMax), $.each(b.data_.abilities,
	function(a, d) {
		b.addAbility(d)
	}))
};
ArcheAge.Web.AbilityCalculator.prototype.bindForm = function() {
	...
	a.abilityContainer_.on("click", "div.layer_list > ul.list > li > a",
	function(b) {
...
ArcheAge.Web.AbilityCalculator.prototype.addAbility = function(a, b) {
	if (void 0 == b) {
		for (var c = -1,
	...
	this.getAbility_(a, b);
	this.change_()
};
ArcheAge.Web.AbilityCalculator.prototype.getAbility_ = function(a, b) {
	var c = this,
