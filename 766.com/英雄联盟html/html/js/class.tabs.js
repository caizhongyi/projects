    ...
    Class.tabs = Class.get(
         ...
         * */
        {
            ...
            horizontal : function(index,obj,items,offset){
				var offset = (index.current * this.itemWidth(items));
				if(offset != null)
                	obj.stop(true).animate({ left :- offset },this.options.duration,this.options.easing);
                return this;
            },
            vertical : function(index,obj,items,offset){
				...
				var offset = (index.current * this.itemWidth(items));
				if(offset != null)
					obj.stop(true).animate({ top : - offset },this.options.duration,this.options.easing);
                return this;
            }
        });
