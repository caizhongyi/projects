!function(win) {
    function resize() {
      ...
      //  win.rem = domWidth / 53;
        ...
        console.log(initial_scale);
        viewport.setAttribute("content", "initial-scale=" + initial_scale + ", maximum-scale=" + initial_scale + ", minimum-scale=" + initial_scale + ", user-scalable=no");
