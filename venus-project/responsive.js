var viewportElement, styleElement, designWidth = 750, defaultFontSize = 14 ;
...
function resize(){
    var dpr = window.devicePixelRatio, scale = window.screen.width / designWidth ;
    var size = defaultFontSize / ( designWidth / ( window.screen.width  * dpr) ) ;
    if(  window.screen.width > designWidth ) return ;
