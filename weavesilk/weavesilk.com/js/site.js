  ...
  this.initSound = function() {
    ...
    if (this.audioContext != null) {
      ...
      playClearSound = (function() {
        ...
        loadSilkSound("http://weavesilk.com/js/Clear 1 16-44.m4a", onload);
        num = 1;
        return function() {
          var index;
          if (clears.length > 0) {
      ...
      drawSparkle = null;
      loadSilkSound('http://weavesilk.com/js/Sparks 16-44 -looped.m4a', function(result) {
        drawSparkle = result;
      ...
      drawWhoosh = null;
      loadSilkSound('http://weavesilk.com/js/Draw B2 2048 loop.m4a', function(result) {
        d('woosh', result);
        drawWhoosh = result;
      ...
      blipEffect = null;
      loadSilkSound('http://weavesilk.com/js/Palette A5.m4a', function(result) {
        blipEffect = result;
        return blipEffect.setVolume(0.4);
      });
      bloopEffect = null;
      loadSilkSound('http://weavesilk.com/js/Palette A4.m4a', function(result) {
        bloopEffect = result;
  ...
  $((function(_this) {
    return function() {
      ...
      b.shareUrlFacebook = ko.computed(function() {
        ...
        return "https://www.facebook.com/dialog/feed?app_id=408271179236250&link=" + (escape(url)) + "&picture=" + (encodeURI(b.shareUrlThumbnail())) + "&name=" + 'Silk – Interactive Generative Art' + "&caption=" + (escape('http://weavesilk.com/js/weavesilk.com')) + "&description=" + (encodeURI('Create beautiful flowing art with Silk.')) + "&redirect_uri=" + (encodeURI(url));
      });
