 ...
 * ?
 */
angular.module('app.acl.index.getrolelist', ['app.acl.index.getrolelist.service' ])
    .controller('controller.acl.index.getrolelist',function( $scope,$rootScope, $stateParams, $modal ,$log ,roles , $state ){
        ...
        function getInfo(){
            roles.get( currentPage ,  searchName  , pageSize ).success(function( res ){
                ...
                $rootScope.searchData.name = searchName ;
