 ...
 * ?
 */
angular.module('app.wandao', [])
    .controller('controller.wandao',function( $scope,$rootScope, $stateParams, $modal ,$log , $state ,$http ){
        ...
        var isChange = false;
        function getInfo(){
            $http.get('app/wandao/data.json').success(function( res ){
                $scope.list = res;
