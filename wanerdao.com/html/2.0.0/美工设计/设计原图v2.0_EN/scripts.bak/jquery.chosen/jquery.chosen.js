    ...
    */
    ...
    $.fn.extend({
        chosen: function (data, options) {
            /*$(document).unbind('click.chosen').bind('click.chosen',function(){
    ...
    Chosen = (function () {
        function Chosen(elmn) {
            ...
            if (!$('body').attr('data-chosen-click')) {
                $('body').attr('data-chosen-click', true);
                var _this = this;
                $(document).unbind('click.chosen').bind('click.chosen', function () {
                    //var chzncontainer = $('.chzn-container');
                    //$('.chzn-drop',chzncontainer).css({left:' -9000px'});
        ...
        Chosen.prototype.set_up_html = function () {
            ...
            if (this.is_multiple) {
                ...
                container_div.html('<a href="javascript:void(0)" class="chzn-single" title="' + this.default_text + '"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');
            }
        ...
        Chosen.prototype.mouse_leave = function () {
            $(this.form_field).next().css('z-index', '0');
            return this.mouse_on_container = false & this.results_hide();
        };
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if (data.group) {
                    ...
                    if (data.selected && this.is_multiple) {
                        ...
                        this.selected_item.find("span").text(data.text).attr('title', data.text);
                    }
                }
            }
            this.show_search_field_default();
        ...
        Chosen.prototype.result_add_option = function (option) {
            ...
            if (!option.disabled) {
                ...
                return '<li id="' + option.dom_id + '" class="' + classes.join(' ') + '" title="' + option.html + '">' + option.html + '</li>';
            } else {
                return "";
            }
        };
        ...
        Chosen.prototype.results_show = function () {
            ...
            if (!this.is_multiple) {
                $.tempChosen = this;
                $(this.form_field).next().css('z-index', 10);
