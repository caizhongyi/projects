<%@ Page Title="" Language="C#" MasterPageFile="~/WanerDaoMasterPage.master" AutoEventWireup="true" CodeFile="Activity_item_main.aspx.cs" Inherits="Activity_Activity_item_main" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="main jz">
    	<div class="home_page ofh">
            ...
            <a href="#" class="attention" onclick="addfollowactivitycategory()"></a>
          ...
          <div class="activity_attention" id="activity_attention"></div>
           ...
           <div class="activity_sub" id="activity_sub">
            <span><a href="#" class="active">活动列表</a></span>
            <span style="display:none;"><a href="#">相关资料</a></span>
    ...
    <script type="text/javascript"> var section_type = '2',opertype = 'activityitempagesearchactivity';</script>
