<%@ Page Title="预览个人相册-个人-玩儿道" Language="C#" MasterPageFile="~/WanerDaoMasterPage.master" AutoEventWireup="true" CodeFile="Personal_Photo_album_Preview.aspx.cs" Inherits="Personal_Personal_Photo_album_Preview" %>
...
<%} %>
        <div class="pa_tit clearfix">
			<div class="alb_set alb_setExt"><b class="ico_myalb"></b>我的相册<strong><span class="album_count">loading</span></strong></div>
			...
			<div class="alb_rt">
				<div class="alb_tag other_sty clearfix">
					<div class="tag_lt">
						...
						<a href="javascript:void(0)" class="doc"></a><a href="javascript:void(0)" class="pri"></a>
					</div>
				...
				<div class="alb_pre_wp">
					<ul class="alb_list preview_pic clearfix">
...
<asp:Content ContentPlaceHolderID="Script" runat="server" >
    ...
    <script src="../Scripts/person/photo_album_preview.js" type="text/javascript"></script>
</asp:Content>