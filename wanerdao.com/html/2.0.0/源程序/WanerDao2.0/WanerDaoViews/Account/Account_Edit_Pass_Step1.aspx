<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Account_Edit_Pass_Step1.aspx.cs" Inherits="Account_Account_Edit_Pass_Step1" %>
...
<body>
    ...
    <div class="jz yh">
    	<div class="account">
        	<div class="sub_nav">
                <a href="account_set_security.html">安全密保</a>
            ...
            <div class="layout_m">
                <ul class="account_nav">
                    ...
                    <li class="link"><i>2</i><span>填写新密码</span></li>
                </ul>
                <form  class="accout_edit_form"  onsubmit="return false;">
                <table width="100%" height="170" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="26%" height="50" align="right" class="f14">帐号：</td>
                    <td width="74%" height="50"><input type="text" class="input_a" id="account" name="account" /></td>
                  </tr>
                  <tr>
                    <td align="right" height="50" class="f14">密码：</td>
                    <td><input type="password" class="input_a" id="password" name="password"/></td>
                  </tr>
                  <tr>
                    <td align="right" height="90">&nbsp;</td>
                    <td><input type="submit" class="input_sub" value="下一步" id="nextstep" />
                    </td>
                  </tr>
                </table>
                </form>
