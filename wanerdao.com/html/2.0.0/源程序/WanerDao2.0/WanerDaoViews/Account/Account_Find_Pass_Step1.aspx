...
<body>
    ...
    <div class="jz yh">
        ...
        <ul class="account_nav">
            <li class="active"><i>1</i><span>填写帐号</span></li>
            <li class="link"><i>2</i><span>身份验证</span></li>
        ...
        <table width="100%" class="f14" height="170" border="0" cellspacing="1">
          <tr>
            <td width="26%" height="44" align="right">请输入您的帐号：</td>
            <td width="74%"><input type="text" class="input_a" /></td>
          </tr>
          <tr>
            <td align="right">&nbsp;</td>
