...
function find_acc_2_onload() {
    $.ajax({
        ...
        dataType: "json",
        cache: false,
        data: "{opertype:'findaccgetsecurityquestion',semail:'" + $("#txtEmail").val() + "'}",
        error: function (data) {
        ...
        success: function (data) {
            if (!data.result) {
                ...
                if (data.total == 0) {
                    alert(wanerdaoLangTip('acc_00042'));
                } else {
    ...
    $("#nextstep").click(function () {
        if (find_acc_2_valid_an1() && find_acc_2_valid_an2()) {
            alert($("#answer1").attr("qid").escapeSpecialchar());
            ...
            $.ajax({
                ...
                dataType: "json",
                cache: false,
                data: "{opertype:'findaccvalidsecurityquesion'," + $("#answer1").attr("qid").escapeSpecialchar() + ":'" + $("#answer1").val() + "'," + $("#answer2").attr("qid").escapeSpecialchar() + ":'" + $("#answer2").val() + "'}",
                error: function (data) {
