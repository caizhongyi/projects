...
function paginDiscuss(currPage){
    $("#DiscussPageDiv").empty().myPagination({
...
function databind(data) {
    if (data.result && data.rows) {
        ...
        $.each(data.rows, function (i, v) {
            ...
            var html = "<li class='report' id=\"event"+id+"\"><span>创建人：" + v.name + "<label>" + v.begin_date + "</label> ";
            if (v.ghid == null || v.ghid == "") {
        ...
        success: function (data) {
            ...
            $.each(data.rows, function (i, v) {
                if (v.ismanage != "T" || v.isEditdemocratic != "T")
                    ...
                    $("#li_eventdescription").append("<label id='lab_eventdes"+v.id+"' style='display:none' class='labevent'>" + v.event_description + "</label>");  
            });
            ...
            box.load("../relationship/ManagementStructrue.htm", "", function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#txt_vote_pass_rate").val(data.rows[0].public_life);
        ...
        case "36639d9b-8a16-11e1-8de6-101f74b66417": //超级管理员变动
            box.load("../relationship/oversupermanager.htm", "", function () {
                $("#btngroup").click(function () {
                    wanerdaogroupmember({
                        comopts: { elementid: 'btngroup', groupid: groupid, callback: showdata }
                    });
                });
...
function cancelEvent() {
 ...
 function submitBaseInfo() {
     ...
     $.ajax({
         ...
         dataType: "json",
         cache: false,
         data: "{opertype:'submitbudget',event_id:'" + $("#sel_event").val() + "',group_id:'" + groupid + "',title:'" + $("#txt_baseInfoTitle").val() + "',content:'" + $("#txt_baseInfoComment").val() + "',link_value1:'" + basekey + "',link_value2:'" + link_value2 + "',link_value3:'" + link_value3 + "',link_value8:'" + t + "'}",
         error: function (data) {
             alert("error")
         },
         success: function (data) {
 ...
 function submitovermanager() {
     ...
     $.ajax({
         ...
         dataType: "json",
         cache: false,
         data: "{opertype:'submitbudget',event_id:'" + $("#sel_event").val() + "',group_id:'" + groupid + "',title:'" + $("#txt_managertitle").val() + "',content:'" + $("#txt_managercontent").val() + "',link_value1:'" + $("#hid_peopleid").val() + "',link_value2:'" + $("#txt_peoplename").val() + "',link_value8:'" + t + "'}",
         error: function (data) {
             alert("error")
         },
         success: function (data) {
 ...
 function submitchange() {
     ...
     $.ajax({
         ...
         dataType: "json",
         cache: false,
         data: "{opertype:'submitbudget',event_id:'" + $("#sel_event").val() + "',group_id:'" + groupid + "',title:'" + $("#txt_managertitle").val() + "',content:'" + $("#txt_managercontent").val() + "',link_value1:'" + $("#sel_action").val() + "',link_value2:'" + $("#hid_peopleid").val() + "',link_value3:'" + $("#txt_peoplename").val() + "',link_value8:'" + t + "'}",
         error: function (data) {
             alert("error")
         },
         success: function (data) {
