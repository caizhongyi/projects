...
function addImage(info) {
    ...
    var img = jQuery('<li style="display:none;"><div class="pic"><a href="javascript:;"><img src="' + info[0] 
    + '" alt="" width="130px" height="106px"></a></div><div class="info"><a href="javascript:;">' + info[2]
     + '</a></div><a href="javascript:void(0);" class="delete"></a></li>').appendTo($('#photoList'));
    img.fadeTo('slow', 1);
