var setLayerCount = '3';// 设置层数
var commentCount = '2'; // 每一层回复显示个数
$(function () {
    $("#pageid").myPagination({
        currPage: 1,
        callback: test1,
...
function appendHtml(Data, currentLayer, showLayer) {
    ...
    if (parseInt(currentLayer) < parseInt(showLayer)) {
        ...
        $.each(Data, function (i, msg) {
            if (isTop == 0) { varTopHtml = "<div class=\"newsList\">"; } else { varTopHtml = "<div class=\"newsListHf\">"; active_posts_id = msg.active_posts_id; follow_id = msg.follow_id; }
