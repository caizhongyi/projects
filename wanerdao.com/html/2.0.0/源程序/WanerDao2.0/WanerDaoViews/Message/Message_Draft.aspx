<%@ Page Title="草稿箱-站内信息-玩儿道" Language="C#" MasterPageFile="~/WanerDaoMasterPage.master" AutoEventWireup="true" CodeFile="Message_Draft.aspx.cs" Inherits="Message_Message_Draft" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<meta name="keywords" content="草稿箱，站内信息，玩儿道，生活社交网络" />
<meta name="description" content="存放自动保存或者用户手动保存的编写信息" />
    	...
    	<div class="home_page clearfix">
            <div class="message_left"> 
                <h1>
                    ...
                    <a href="draft.html" class="active">草稿箱</a>
            ...
            <div class="message_right">
                <div class="message_Box">
                    <div class="subChaTab">
                        <a class="active" href="javascript:;">站内消息</a>
                    </div>
                   ...
                   <div class="blank10px"></div>
                   <div class="blank10px"></div>
                   <a href="#" class="downLoadMore" id="showmore"><i>加载更多</i></a>  
                   <div class="blank10px"></div>
                   <div class="blank10px"></div>
                   <div class="mesBar pager">
