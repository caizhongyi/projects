<%@ Page Title="" Language="C#" MasterPageFile="~/WanerDaoMasterPage.master" AutoEventWireup="true" CodeFile="message_send.aspx.cs" Inherits="message_message_send" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
<title>Send box-Message-Savorboard</title>
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
<meta name="keywords" content="Send box, Message, Savorboard, Life and social network" />
<meta name="description" content="Send box" />
        ...
        <div class="mes_box clearfix">
            ...
            <div class="mes_box_left">
                <div class="mes_nav_box">
                    ...
                    <a href="send.html" class="active">Send</a>
            ...
            <div class="mes_box_right">
                <div class="mes_com_box">
                    <div class="mes_com_box_Tab">
                        <a class="active" href="javascript:;">Message</a> <a href="send_invite.html">Invitation</a>
                    </div>
                    <div class="black10">
                    </div>
                    <div class="black10">
                    ...
                    <div class="imporInfo">
                       ...
                       <%-- <div class="loading" id="showmore"><a href="javascript:;">加载更多</a></div>--%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="Server">
    ...
    <script src="/scripts/message/send.js" type="text/javascript"></script>
</asp:Content>
