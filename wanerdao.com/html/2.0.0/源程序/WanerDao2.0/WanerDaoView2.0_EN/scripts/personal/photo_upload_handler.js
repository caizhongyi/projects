...
function addImage(info) {
    ...
    + '" alt="" style="width: 148px; height: 104px;"></a><div class="photos-name" style="height:18px; overflow: hidden"><a href="javascript:;" title="' + info[2] + '">' + info[2]
     + '</a></div></li>').appendTo($('#photoList'));
    img.fadeTo('slow', 1);
