...
//            });
            ...
            // tools.append($wd.format('<dd class="log_viewbg01"><a href="javascript:void(0);">Focus（' + v.counter + '）</a></dd>')); //focus
            //focusBlog(\'{2}\',this)

            if (is_self) {
                var link_edit = jQuery('<dd class="log_viewbg02"><a href="javascript:void(0);">Edit</a></dd>').appendTo(tools);
            ...
            getCommentByBlogId(v.id, function (data) {
                ...
                var comment_link = jQuery('<a href="javascript:void(0);" class="cli_pl">Comment</a>').appendTo(comment_span);
            });
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.result && data.rows) {
                var box = $('#articlecat');
                $.each(data.rows, function (i, v) {
                    var li = jQuery('<li class="listM_li"><span class="ontab" style="display:none"><input type="text" class="inp55" readonly="readonly" value="Action" style=" width: 50px" />'
                        + '<ul class="test_xl" style="width:50px; height:25px; display:none;">'
                    //  + '<li style="padding-left:0px;"><a href="javascript:;">Save</a></li>'
                            + '<li style="padding-left:0px;"><a href="javascript:;">Print</a></li>'
