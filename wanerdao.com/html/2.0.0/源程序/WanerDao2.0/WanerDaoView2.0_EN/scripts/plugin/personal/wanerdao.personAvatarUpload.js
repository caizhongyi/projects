(function () {
    ...
    var defaults = {
        width: 300,
        height: 400,
        notselectmsg: 'Please select the clip area',
        requestfail: 'Request fails！',
        file_null: 'Please select the photo！',
        text_choose_photo_btn: 'Choose',
        text_upload_btn: 'Upload',
        text_uploading: 'Upload....',
        text_cut_avatar_btn: 'Clip',
        text_reupload_btn: 'Re-upload',
        file_ext_error: 'Please select a valid image file (format:jpg|jpeg|gif|bmp|png)!',
        callback: null,
    ...
    $.personAvatarUpload = function (opts) {
        ...
        $('#person_avatar_upload_win').remove();

        var box = jQuery('<div id="person_avatar_upload_win" ></div>').appendTo($('body'));
    ...
    function doUpload($main, $obj) {
        $obj.empty();
        $main.css({ 'width': '235px', 'height': '70px' });
        ...
        + '<span class="' + defaults.class_upload_btn + '"><span>' + defaults.text_choose_photo_btn + '</span><input type="file" name="avatar" id="javatar" accept="image/*" /></span>'
        ...
        $upload_box.submit(function () {
            ...
            if (fileExtName == "jpg" || fileExtName == "jpeg" || fileExtName == "gif" || fileExtName == "bmp" || fileExtName == "png") {
                ...
                new pop({ typename: 'error',
                    msginfo: defaults.file_ext_error
                });
                return false;
            }
        });
