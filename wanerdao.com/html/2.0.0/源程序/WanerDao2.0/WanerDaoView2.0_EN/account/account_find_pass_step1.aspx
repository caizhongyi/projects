<%@ Page Language="C#" AutoEventWireup="true" CodeFile="account_find_pass_step1.aspx.cs" Inherits="account_account_find_pass_step1" %>
...
<meta name="keywords" content="Fillaccount, Find password, Account, Savorboard, Life and social network" />
<meta name="description" content="Find password 1st step, fill account" />
...
<div class="container layout">
    <div class="tabs">
    	<ul class="tabs-nav">
        	<li><a href="login.html">Log in</a></li><li><a href="register.html">Sign up</a></li><li><a href="find_account.html">Find Username </a></li><li class="current"><a href="javascript:;">Find Password</a></li>
        </ul>
        <div class="bigbox">
            ...
            <div class="box_bd">
                ...
                <div class="form">
                    <ul>
                		<li><label class="label" for="input_a">Enter username:</label>
                        <input name="input_a" id="input_a" type="text" class="text" maxlength="60" maxlength="60"/></li>
                    </ul>
                   <div class="submit"><a  href="javascript:;" id="nextstep" class="button button1">Next</a></div>
                </div>
            </div>
