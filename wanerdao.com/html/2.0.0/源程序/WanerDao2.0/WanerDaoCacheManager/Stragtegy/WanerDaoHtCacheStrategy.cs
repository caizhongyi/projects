...
{
    /// <summary>
    /// 描述：使用HashTable实现内存缓存
    /// 创建者：金广亮
    /// 创建时间：2011-9-21
    /// </summary>
    public class WanerDaoHtCacheStrategy:ICacheStrategy
    {
        /// <summary>
        /// 默认缓存存活期为3600秒(1小时)
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        static WanerDaoHtCacheStrategy()
        {
        ...
        public static Hashtable GetHtCacheObj
        {
            get { return htCache; }
        }
