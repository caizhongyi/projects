/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2011-11-14 23:59:10                          */
/*==============================================================*/
...
drop table if exists InfoActivityRecordsComments;

drop table if exists InfoSectionPage;

drop table if exists InterfaceCategory;

drop table if exists InterfaceService;

drop table if exists InviteFriendsStats;
...
drop table if exists ToolApproval;

drop table if exists ToolCategory;

drop table if exists ToolPackage;
...
(
   ...
   sort_id              int not null auto_increment,
   state_id             varchar(40),
   city_name_en         varchar(60),
   city_name_cn         varchar(60),
...
(
   ...
   parent_id            varchar(40),
   department_name_en   varchar(60),
   department_name_cn   varchar(60),
   description          text,
   web_link             varchar(60),
   update_date          timestamp,
   active               bool default true,
...
(
   ...
   sort_id              int not null auto_increment,
   city_id              varchar(40),
   district_name_en     varchar(60),
   district_name_cn     varchar(60),
   update_date          timestamp,
   active               bool default true,
   primary key (sort_id)
);
...
(
   ...
   dorm_name_en         varchar(60),
   dorm_name_cn         varchar(60),
   description          text,
   update_date          timestamp,
   active               bool default true,
   primary key (sort_id)
...
/*==============================================================*/
/* Table: InfoActivityRecordsComments                           */
/*==============================================================*/
create table InfoActivityRecordsComments
(
   id                   varchar(40) not null,
   sort_id              int not null auto_increment,
   record_id            varchar(40),
...
alter table InfoActivityRecordsComments comment '活动信息讨论回复';
...
(
   ...
   logo_path            varchar(200),
   template_id          int,
   comp_version         varchar(60),
   update_date          datetime,
   active               bool default true,
   primary key (sort_id)
);

alter table InfoSectionPage comment '资道信息模块';

/*==============================================================*/
/* Table: InterfaceCategory                                     */
/*==============================================================*/
create table InterfaceCategory
(
...
alter table InterfaceCategory comment '接口分类';

/*==============================================================*/
/* Table: InterfaceService                                      */
/*==============================================================*/
create table InterfaceService
(
   id                   varchar(40) not null,
   name                 varchar(60),
   category             varchar(40),
   description          text,
   interface_name       varchar(60),
   user_guide           text,
   create_name          varchar(60),
   create_date          datetime,
   active               bool default true,
...
alter table InterfaceService comment '接口服务';

/*==============================================================*/
/* Table: InviteFriendsStats                                    */
/*==============================================================*/
create table InviteFriendsStats
(
   id                   int not null auto_increment,
   user_id              varchar(40),
   stats_num            int,
...
alter table InviteFriendsStats comment '邀请好友统计';
...
alter table SiteApplication comment '站点应用程序';
...
alter table ToolApproval comment '插件审批';
...
(
   id                   varchar(40) not null,
   sort_id              int not null auto_increment,
   serial_nbr           varchar(40),
   version              varchar(20),
   developer_id         varchar(40),
   secrect              varchar(40),
   url                  varchar(100),
   logo_location        varchar(60),
   rate                 int,
...
alter table ToolPackage comment '插件工具信息';
