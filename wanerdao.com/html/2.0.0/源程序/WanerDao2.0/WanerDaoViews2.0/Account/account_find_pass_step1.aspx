...
<meta name="keywords" content="填写账号，找回密码，账号维护，玩儿道，生活社交网络" />
<meta name="description" content="找回密码第一步，填写登陆账号" />
...
<div class="container layout">
    <div class="tabs">
    	<ul class="tabs-nav">
        	<li><a href="login.html">用户登录</a></li><li><a href="register.html">新用户注册</a></li><li><a href="find_account.html">找回账号 </a></li><li  class="current"><a href="javascript:;">找回密码</a></li>
        </ul>
        <div class="bigbox">
            ...
            <div class="box_bd">
                ...
                <div class="form">
                    <ul>
                		<li><label class="label" for="input_a">请输入您的账号:</label>
                        <input name="input_a" id="input_a" type="text" class="text" maxlength="60" maxlength="60"/></li>
                    </ul>
                   <div class="submit"><a  href="javascript:;"  id="nextstep" class="button button1">下一步</a></div>
                </div>
            </div>
