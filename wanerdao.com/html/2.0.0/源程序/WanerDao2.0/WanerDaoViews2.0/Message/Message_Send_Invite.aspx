<%@ Page Title="" Language="C#" MasterPageFile="~/WanerDaoMasterPage.master" AutoEventWireup="true"
    CodeFile="Message_Send_Invite.aspx.cs" Inherits="Message_Message_Send_Invite" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>邀请发送箱-站内信息-玩儿道</title>
            ...
            <div class="mes_box_right">
                <div class="mes_com_box">
                    <div class="mes_com_box_Tab">
                        <a href="send.html">站内信息</a> <a href="javascript:;" class="active">邀请</a>
                    </div>
                    <div class="black10">
                    </div>
                    <div class="black10">
                        ...
                        <div class="topNav clearfix ">
                        	<div class="f_left">
                                ...
                                <div class="opera opera_send_inv">
                                		...
                                		<a href="javascript:void(0);" class="icon_2" title="重新发送"></a>
