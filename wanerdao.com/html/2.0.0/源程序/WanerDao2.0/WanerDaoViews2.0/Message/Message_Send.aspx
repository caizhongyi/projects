<%@ Page Title="" Language="C#" MasterPageFile="~/WanerDaoMasterPage.master" AutoEventWireup="true"
    CodeFile="Message_Send.aspx.cs" Inherits="Message_Message_Send" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>发送箱-站内信息-玩儿道</title>
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <meta name="keywords" content="发送箱，站内信息，玩儿道，生活社交网络" />
    <meta name="description" content="存放站内信息" />
        ...
        <div class="mes_box clearfix">
            ...
            <div class="mes_box_left">
                <div class="mes_nav_box">
                    ...
                    <a href="send.html" class="active">发件箱</a>
            ...
            <div class="mes_box_right">
                <div class="mes_com_box">
                    <div class="mes_com_box_Tab">
                        <a class="active" href="javascript:;">消息</a> <a href="send_invite.html">邀请</a>
                    </div>
                    <div class="black10">
                    </div>
                    <div class="black10">
