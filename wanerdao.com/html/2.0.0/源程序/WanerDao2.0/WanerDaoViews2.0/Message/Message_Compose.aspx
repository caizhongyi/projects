<%@ Page Title="" Language="C#" MasterPageFile="~/WanerDaoMasterPage.master" AutoEventWireup="true"
    CodeFile="Message_Compose.aspx.cs" Inherits="Message_Message_Compose" %>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="head">
    <title>编写信息-站内信息-玩儿道</title>
            ...
            <div class="mes_box_right">
                <div class="mes_com_box">
                    <div class="mes_com_box_Tab">
                        <a href="javascritp:;" class="active">站内信息</a> 
                        ...
                        <ul>
                            ...
                            <div class="submit">
                                ...
                                <input type="button" class="buttonB btn_w135 btn_h36 btnBlue_135 fSize-14 savemsg"
                                    value="保  存">
                                <input type="button" class="buttonB btn_w97 btn_h36 btnGary_97 fSize-14 cancel" value="取 消">
                            </div>
                        </ul>
                        <div class="blank10px">
