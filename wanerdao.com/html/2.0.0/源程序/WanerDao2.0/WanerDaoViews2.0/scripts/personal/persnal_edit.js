...
function setBaseInfo() {
    ...
    ul_baisc.append($wd.format('<li><label>' + wanerdaoLangTip('personal_00032') + '：</label> {0}-{1}-{2} <span class="hobby-wrap"><b class="hobby_sx">' + wanerdaoLangTip('personal_00033') + '：<a>{3}</a>' + wanerdaoLangTip('personal_00034') + '：<a class="m0">{4}</a></b></span></li>', baseinfo.birthday_year, baseinfo.birthday_month, baseinfo.birthday_day, zodiac[(baseinfo.birthday_year - 3) % 12], (baseinfo.constellation || initConselaction())));
    ...
    if (self) {
        ...
        link_edit.click(function () {
            if (basic_box.find('.hobby_listB').length == 0) {
                ...
                li_birthday.append('<span class="hobby-wrap"><b class="hobby_sx">' + wanerdaoLangTip('personal_00033') + '：<a id="personal_zodiac"></a>' + wanerdaoLangTip('personal_00034') + '：<a class="m0" id="personal_constellation"></a></b></span>');
    ...
    if (self) {
        ...
        link_edit.click(function () {
            if (interest_box.find('.hobby_listB').length == 0) {
                ...
                var ul_edit_item = jQuery('<ul></ul>').appendTo(edit_box.find('.hobby_tagC'));
                ul_edit_item.append('<li>注意：多个内容输入请用逗号“，”分隔</li>');
                var li_music = jQuery('<li><label>' + wanerdaoLangTip('personal_00061') + '：</label></li>').appendTo(ul_edit_item);
                var interest_music = jQuery('<input type="text" class="text" style="width:390px" id="interest_music" maxlength="60"  />').appendTo(li_music);
                ...
                var interest_movie = jQuery('<input type="text" class="text" style="width:390px" id="interest_movie" maxlength="60"  />').appendTo(li_movie);
                ...
                var interest_game = jQuery('<input type="text" class="text" style="width:390px" id="interest_game" maxlength="60"  />').appendTo(li_game);
                ...
                var interest_cartoon = jQuery('<input type="text" class="text" style="width:390px" id="interest_cartoon" maxlength="60"  />').appendTo(li_cartoon);
                ...
                var interest_book = jQuery('<input type="text" class="text" style="width:390px" id="interest_book" maxlength="60"  />').appendTo(li_book);
                ...
                var interest_sport = jQuery('<input type="text" class="text" style="width:390px" id="interest_sport" maxlength="60"  />').appendTo(li_sport);
    ...
    if (self) {
        ...
        link_edit.click(function () {
            if (contact_box.find('.hobby_listB').length == 0) {
                ...
                var contact_email = jQuery('<input type="text" class="text f_left" style="width:260px" id="contact_email" maxlength="60" readonly="readonly"/>').appendTo(li_email);
                ...
                var contact_skype = jQuery('<input type="text" class="text f_left" style="width:260px" id="contact_skype" maxlength="60"  />').appendTo(li_skype);
                ...
                var contact_msn = jQuery('<input type="text" class="text f_left" style="width:260px" id="contact_msn"  maxlength="60" />').appendTo(li_msn);
                ...
                var contact_cell = jQuery('<input type="text" class="text f_left" style="width:260px" id="contact_cell" maxlength="60"  />').appendTo(li_cell);
                ...
                var contact_website = jQuery('<input type="text" class="text f_left" style="width:260px" id="contact_website" maxlength="60"  />').appendTo(li_website);
