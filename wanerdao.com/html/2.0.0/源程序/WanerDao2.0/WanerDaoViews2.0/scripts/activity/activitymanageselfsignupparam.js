...
(function ($) {
    $.fn.selfsignupparam = function () {
        ...
        //获取其UI
        function _getUI() {
            var ui = '<div id="divstep" class="setmodList applyPerson" style="margin:0" ';
            ui += '<dl>';
            ui += ' <dd class="formTitle" style="width:75px;">准备通过：</dd>';
            ui += ' <dd class="formMain">';
            ui += ' <select id="vehicle" name="vehicle" style="width:80px;"/>';
            ui += ' 参加活动';
            ui += '<span id="takecar" style="display:none">';
            ui += ' <select id="ifVehicle" name="ifVehicle" style="width:59px;">';
            ...
            ui += '</dd>';
            ui += '</dl>';
            ui += '<dl class="clear2" style="padding:0px;"  />';
            ui += '<dl id="dlfare" style="display:none">';
            ui += ' <dd class="formTitle"  style="width:75px;">搭车费：</dd>';
            ui += ' <dd class="formMain">';
            ui += '     <select name="takeFare" id="takeFare" style="width:80px;"/>';
            ...
            ui += ' <dd class="formTitle"  style="width:75px;">车型：</dd>';
            ui += ' <dd class="formMain">';
            ui += '      <select name="licensePlate" id="licensePlate" style="width:80px;"/>';
            ui += '     <select id="model" name="model" style="width:114px;"><option value="-2">请选择车型</option></select> &nbsp;&nbsp;&nbsp;';
            ui += '     车牌号：<input id="txtcarid" type="text" class="text"  style="width:113px;"/>';
            ui += ' </dd>';
            ui += '</dl>';
            ui += '<dl class="clear2" style="padding:0px;"  />';
            ui += '<dl id="dlyear" style="display:none">';
            ui += ' <dd class="formTitle"  style="width:75px;">年代：</dd>';
            ui += ' <dd class="formMain">';
            ui += '      <input type="text" class="text" id="txtcaryear"  style="width:189px;"/>';
            ui += '     愿意提供空位数';
            ui += '     <input id="txtcarseat" type="text" class="text"  style="width:113px;"/>';
            ui += ' </dd>';
            ui += '</dl>';
            ui += '<dl class="clear2" style="padding:0px;"   />';
            ui += '</div>';
