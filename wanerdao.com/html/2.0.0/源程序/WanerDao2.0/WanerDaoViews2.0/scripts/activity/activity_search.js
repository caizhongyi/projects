    ...
    function searchList(data) {
        ...
        if (data.result != false) {
            $.each(data.rows, function (i, msg) {
                ...
                strContent += ("<div class=\"o_event\"><span class=\"f14\"><a href=\"/personal/personal_info.html?uid=" + msg.original_id + "\" target=\"_bank\">" + msg.name + "</a> 发起 <a href=\"/activity/activity_index.html?id=" + msg.id + "\" target=\"_blank\">" + subPoints(msg.activity_name, 40) + "</a><a href='javascript:;' title='" + msg.address + "'> [" + subPoints(msg.address, 20) + "]</a> &nbsp;现人数/总数：(<font class=\"red\">" + msg.join_member_nbr + "/" + msg.max_nbr + "</font>)</span>" + dateStr(msg.datetime) + "</div>"); //" + dateStr(msg.datetime) + "
