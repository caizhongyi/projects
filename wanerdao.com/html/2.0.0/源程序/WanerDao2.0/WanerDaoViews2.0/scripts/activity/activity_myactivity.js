...
function followactivity(id, objthis, opertype) {
    ...
    ajaxfunc("activitycategory_follow.axd", "{opertype:'" + opertype + "',attention_id:'" + id + "'}", errorFunc, function (data) {
        ...
        if (objthis.val() == "+" + wanerdaoLangTip('active_00050') && data.result == true) {
            objthis.val("-" + wanerdaoLangTip('active_00051'));
        } else if (objthis.val() == "-" + wanerdaoLangTip('active_00051')  && data.result == true) {
            objthis.val("+" + wanerdaoLangTip('active_00050'));
        }
    });
}
...
$("#btnfollow,#btnmanagefllow").live("click", function () {
    if ($(this).val() == "+" + wanerdaoLangTip('active_00050')) {
        followactivity(activity_id, $(this), "followactivity");
    }
    else if ($(this).val() == "-" + wanerdaoLangTip('active_00051')) {
