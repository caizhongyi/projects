        ...
        $.each(data.rows, function (i, v) {
            ...
            if (v.msg_type == "1") {//圈子
                ...
                li.append('<dl class="fInfo">'
                            + '<dt><i class="date">' + dateStr(v.send_date) + '</i><i class="icon i_2"><a href="/personal/index.html?id=' + v.send_id + '" target="_blank" title="' + v.send_username + '">' + v.send_username + '</a> 邀请您加入 <a href="/relationship/relationship_mygroup_info.html?id=' + jsonOBJ.id + '" class="fb">' + jsonOBJ.group_name + '</a> (<b class="red">' + jsonOBJ.member_nbr + '人</b>)</i></dt>'
                            + '<dd><p></p></dd>'
                ...
                li.append('<dl class="fInfo">'
                            + '<dt><i class="date">' + dateStr(v.send_date) + '</i><i class="icon i_3"><a href="/personal/index.html?id=' + v.send_id + '">' + v.send_username + '</a> 邀请您加入 <a href="#" class="fb">' + jsonOBJ.active_name + '</a> ' + (jsonOBJ.address ? '[' + jsonOBJ.address + ']' : '') + '(<b class="red">' + jsonOBJ.member_count + '人</b>)</i></dt>'
                ...
                li.append('<dl class="fInfo">'
                            + '<dt><i class="date">' + dateStr(v.send_date) + '</i><i class="icon i_1 fb"><a href="/personal/index.html?id=' + v.send_id + '" class="fb">' + jsonOBJ.name + '</a>请求与您成为好友' + (jsonOBJ.place ? '[' + jsonOBJ.place + ']' : '') + '</i></dt>'
