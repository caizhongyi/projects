...
(function ($) {
    ...
    function getstepsui() {
        ...
        ui += '<input type="button" class="button blue-radius-btn" button-loading="' + wanerdaoLangTip('common_00071') + '" button-loading-class="button disable-radius-btn" value="' + wanerdaoLangTip('active_00076') + '"  id="createactivity"/>&nbsp;&nbsp;';
        ui += '<input type="button" class="button gay-radius-btn" value="' + wanerdaoLangTip('active_00077') + '"  id="saveactivityparam"/>&nbsp;&nbsp;';
        ui += '<input type="button" class="button gay-radius-btn" value="' + wanerdaoLangTip('common_00016') + '" id="cancelactivity"/></span>';
        return ui;
    };
    //第一次显示
