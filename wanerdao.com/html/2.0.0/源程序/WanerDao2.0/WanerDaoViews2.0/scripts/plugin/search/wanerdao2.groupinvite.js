...
jQuery.extend({
    getUI: function () {
        var ui = '<div class="select_pep_bot">';
        ui += ' <p>';
        ...
        ui += '  <div class="select_name_list" id="groupnewlist"><img class="this_pep1" src="/images/this_pep.png">  </div>';
        ui += '  </div>';
        ui += '</div>';
        ...
        ui += '  <div class="select_pep_name">';
        ui += '    <div class="select_name_list" id="friendnewlist"><img class="this_pep2" src="/images/this_pep.png"></div>';
        ui += '  </div>';
        ui += '</div>';
...
//                        jQuery(this).find('a img').click(function () {
//                            jQuery(this).remove();
                        //                        });
                        jQuery(this).remove();
