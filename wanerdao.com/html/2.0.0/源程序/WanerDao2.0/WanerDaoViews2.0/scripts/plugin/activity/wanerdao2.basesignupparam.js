...
(function ($) {
    ...
    function _aUI() {
        ...
        ui += '<dl class="clear2"/>';
        ui += '<dl>';
        ui += ' <dd class="formTitle"><label><input type="checkbox" id="ckactivityisprotect"/></label></dd>';
    ...
    function _dEvent() {
        ...
        $("#btnactivitybudgetadd").click(function () {
            ...
            if ($("#btnactivitybudgetadd").val() == "添加预算名目") {
                var _title = $("#txtactivitybudgetname").val();
                ...
                if ($("#txtactivitybudgetmark").val().length > 200) {
                    new pop({ typename: 'error',
                ...
                if (_title != '') {
                    var obj = $("#tableactivitybudget tr:gt(0)");
                    var _f = true;
                    $.each(obj, function (i, n) {
                        var o = $(obj[i]);
                        if (o.find("td:eq(1)").text() === _title) {
                            _f = false;
                            return false;
                        }
                    });
