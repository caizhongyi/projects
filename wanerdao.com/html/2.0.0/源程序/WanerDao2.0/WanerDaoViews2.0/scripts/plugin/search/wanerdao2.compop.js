        ...
        if (optsparam.typename !== "friends") {
            if (optsparam.groupid.length>=1) {
                ...
                if ($("#" + optsparam.typename + "text").val() !== '' && $("#" + optsparam.typename + "text").val() !== '请输入名字') {
                    otype += "mygroupmemeberpopup',name:'" + $("#" + optsparam.typename + "text").val() + "',oneself:" + optsparam.oneself+",";
                }
                else {
                    otype += "mygroupmemeberpopup',name:'',oneself:" + optsparam.oneself + ",";
                }
                otype += "group_id:'" + optsparam.groupid + "',groupcatory:'" + $("#groupddl").children('option:selected').val() + "'"; 
            }
            else {
                if ($("#" + optsparam.typename + "text").val() !== '' && $("#" + optsparam.typename + "text").val() !== '请输入名字') {
                    otype += "mygrouplist',name:'" + $("#" + optsparam.typename + "text").val() + "',oneself:" + optsparam.oneself;
                }
                else {
                    otype += "mygrouplist',name:'',oneself:" + optsparam.oneself;
                }
           }
        }
        else {//好友查找
