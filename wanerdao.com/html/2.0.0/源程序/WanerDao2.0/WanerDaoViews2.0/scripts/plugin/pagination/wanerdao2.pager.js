    ...
    $.fn.myPagination = function (options) {
        ...
        function getFirst() {
            ...
            if (opts.info && opts.info.first_on && opts.info.first) {
                ...
                else if (pageCount === 1 | currPage === 1) {
                    str = "<span class='" + opts.info.firstdiscls + "'>";
                    str += opts.info.first === undefined ? "" : opts.info.first;
                    str += "</span>";
                }
                else {
                    str = "<a href='javascript:;' title='" + getTipMsg(1) + "' class='" + opts.info.firstcls + "'>";
                    str += opts.info.first === undefined ? "" : opts.info.first;
                    str += "</a>";
                }
                return str + "";
        ...
        function getLast(pageCount) {
            ...
            if (opts.info && opts.info.last_on && opts.info.last) {
                ...
                else if(pageCount === 1 | pageCount === currPage){
                    str = '<span class="' + opts.info.lastdiscls + '">';
                    str += opts.info.last === undefined ? "" : opts.info.last;
                    str += '</span>';
                }
                else {
                    str = "<a href='javascript:;' title='" + getTipMsg(pageCount) + "' class='" + opts.info.lastcls + "'>";
                    str += opts.info.last === undefined ? "" : opts.info.last;
                    str +="</a>";
                }
                return str;
