...
function wanerdaochart(options) {
            ...
            */
            ...
            if (me.opts.tooltip) {
                placeholder.bind("plothover", function (event, pos, item) {
                    if (item) {
                        $(".vote-control").html(item.series.label + ":" + item.series.xaxis.ticks[item.dataIndex].label + "(" + item.datapoint[1] + ")");
                    }
                });
    ...
    function _getUI(titleid) {
        var htext = '<div class="pop" style="width:350px; margin:10px auto;">';
        ...
        htext += '	    <div id="divchart" style="width:280px;height:300px">';
        htext += '		</div>';
