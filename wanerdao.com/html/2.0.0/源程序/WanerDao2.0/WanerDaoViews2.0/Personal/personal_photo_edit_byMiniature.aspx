...
<div id="container" class="container activityMain">
    <div class="tabs">
      <div class="mes_com_box_Tab">
        ...
        <h4 class="tBgb AM_photoAlbum"><b class="icon icon-photo1">相册设置</b><a href="javascript:;" class="icon icon-blist-on">缩略图</a><a href="javascript:;" class="icon icon-mlist" id="photo_list">列表</a></h4>
          <div class="f_left" >
