...
{
    public class WanerDaoThumbnail
    {
        ...
        {
            srcFileName = WanerDaoFileUtils.GetMapPath(FileName);
            try
            {
        ...
        {
            return WanerDaoDES.Encode(aid.ToString() + ",300,300", WanerDaoMD5.MD5(aid.ToString())).Replace("+", "[");
        }
