...
function kkdown(event) {
    ...
    if (kkc == 27) {
        ...
        result();
    } else if (kkc == 48 || kkc == 96) {
        inputkey('0');
    } else if (kkc == 49 || kkc == 97) {
        inputkey('1');
    } else if (kkc == 50 || kkc == 98) {
        inputkey('2');
    } else if (kkc == 51 || kkc == 99) {
        inputkey('3');
    } else if (kkc == 52 || kkc == 100) {
        inputkey('4');
    } else if (kkc == 53 || kkc == 101) {
        inputkey('5');
    } else if (kkc == 54 || kkc == 102) {
        inputkey('6');
    } else if (kkc == 55 || kkc == 103) {
        inputkey('7');
    } else if (kkc == 56 || kkc == 104) {
        inputkey('8');
    } else if (kkc == 57 || kkc == 105) {
        inputkey('9');
    } else if (kkc == 190 || kkc == 110) {
        inputkey('.');
    } else if (kkc == 65) {
        inputkey('a');
    } else if (kkc == 66) {
        ...
        var box = eval("document.calc.hypf");
        box.checked = !box.checked;
        inputshift();
    } else if (kkc == 73) {
        var box = eval("document.calc.shiftf");
        box.checked = !box.checked;
        ; inputshift();
    } else if (kkc == 187 || kkc == 107) {
        operation('+', 5);
    } else if (kkc == 189 || kkc == 109) {
        operation('-', 5);
    } else if (kkc == 80 || kkc == 106) {
        operation('*', 6);
    } else if (kkc == 191 || kkc == 111) {
        operation('/', 6);
    } else if (kkc == 81) {
        var box = eval("document.calc.carry");
        box[0].checked = true;
        inputChangCarry(16);
    } else if (kkc == 87) {
        var box = eval("document.calc.carry");
...
function inputkey(key) {
    ...
    if ((carry == 2 && (index == 48 || index == 49)) || (carry == 8 && index >= 48 && index <= 55) || (carry == 10 && (index >= 48 && index <= 57 || index == 46)) || (carry == 16 && ((index >= 48 && index <= 57) || (index >= 97 && index <= 102))))
        if (endNumber) {
            ...
            document.calc.display.value = key
        else if (getStringLength(document.calc.display.value) <= 15) {//最大为15位
            document.calc.display.value += key;
        }
}
