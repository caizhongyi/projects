<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><?php $cur_menu = 'team';?>
...
<div id="main">
    <div id="productCats" class="flexslider">
        <h2><span>团 队 介 绍</span></h2>

        <div class="subpages-holder semitransp">
            <ul class="submenu">
                <li><a data-id="162" class="subpage-switch active"
                       href="<?php echo buildurl('lists','index','content',array('catid'=>15));?>">摄影师</a></li>
                <li><a data-id="164" class="subpage-switch  "
                       href="<?php echo buildurl('lists','index','content',array('catid'=>16));?>">美工</a></li>
                <li><a data-id="164" class="subpage-switch "
                       href="<?php echo buildurl('lists','index','content',array('catid'=>17));?>">造型师</a></li>
            </ul>
           <div id="content">
