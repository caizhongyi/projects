...
var Countdown = Class.create({
    ...
    populate : function(){
        ...
        var res = {};
        var Day_Param = 1000 * 60 * 60 * 24;//һ����ں�����
        var Hour_Param = 1000 * 60 * 60;//һСʱ���ں�����
        var Minu_Param = 1000 * 60;//һСʱ���ں�����
        var Sec_Param = 1000;//һСʱ���ں�����
        res.day = Math.floor( chaTime / Day_Param );//
        chaTime = chaTime - res.day * Day_Param;//��ȥ��ĺ�����������Сʱ����
