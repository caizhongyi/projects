require('/components/zepto/data.js');
require('/components/zepto/deferred.js');

var Class = window.Class ||  require('class'),
    $ = window.jQuery ||  require('zepto'),
...
var Form =  Class.create({
    ...
    bindEvent : function(){
        ...
        }).on('blur.form','input[name],select[name] , textarea[name]', function(e){
            if( $(this).attr('type') == 'radio' ||  $(this).attr('type') == 'checkbox' ) return ;
