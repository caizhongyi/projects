...
var AutoComplete = Class.create({
    ...
    resize: function(){
        var width = $( this.options.attachment , this.$).width() || this.$.width();
    ...
    pos :function(){
        ...
        if( $el.offset().top /2 + $el.height() > $(window).height() / 2 ){
            pos = {
                left : $el.offset().left,
                top : $el.offset().top - this.$autocomplate.height()
            }
        }
        else{
            pos = {
