 ...
 */
/**
 * @require.async  components/flashcookie/flash_cookie.swf
 */
var $ = require('jquery');

var FlashCookie = exports;

var done =  module.async && module.async();

// ie下flash文件缓存出现__flash_addCallback__错误，可以选择加上版本号或者在flash里面处理
// 这里为了缓存.swf文件，采用后者
var swfUrl =  "http://asset.pc.273.com.cn/components/flashcookie/flash_cookie.swf";
